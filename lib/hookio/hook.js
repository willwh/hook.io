...
Hook.prototype.emit = function (event, data, callback, broadcast) {
  ...
  //
  return EventEmitter.prototype.emit.apply(this, [event, data, callback, broadcast]);
}
