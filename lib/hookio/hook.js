...
var Hook = exports.Hook = function (options) {
  ...
  //
  self.debug           = argv.debug === true || options.debug === true;
  self.defaults.port   = argv['hook-port']   || options['hook-port']   || 5000;
  self.defaults.host   = argv['hook-host']   || options['hook-host']   || 'localhost';
  self.defaults.socket = argv['hook-socket'] || options.socket || null;
...
Hook.prototype.listen = function (options, callback) { 
  ...
  this['hook-port'] = options['hook-port'] || this.defaults.port;
  this['hook-host'] = options['hook-host'] || this.defaults.host;
...
Hook.prototype.connect = function (options, callback) {
  ...
  this['hook-port'] = this['hook-port'] || options['hook-port'] || this.defaults.port;
  this['hook-host'] = this['hook-host'] || options['hook-host'] || this.defaults.host;
