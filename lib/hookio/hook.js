 ...
 *    have TODO blocks or maybe just doesn't make anysense.
 *
...
var Hook = exports.Hook = function (options) {
  ...
  //
  // Map some events to the Hook instance eventMap
  // we can also pass in options.eventMap to extend the eventMap
  //
  this.eventMap(options);
