...
var Hook = exports.Hook = function (options) {
  ...
  self.defaults['hook-port']   = argv['hook-port']   || options['hook-port']   || 5000;
  self.defaults['hook-host']   = argv['hook-host']   || options['hook-host']   || 'localhost';
  self.defaults['hook-socket'] = argv['hook-socket'] || options['hook-socket'] || null;
