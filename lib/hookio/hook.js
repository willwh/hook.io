...
Hook.prototype.start = function (options, callback) {
  ...
  // TODO: create dynamic client / server detection
...
Hook.prototype._listen = function(options, callback){
  ...
  dnode(function(client, conn){
    this.report = function (name) { 
      ...
      if (self._outputs.indexOf(name) === -1) {
        self._outputs.push(name);
      }
    };
...
Hook.prototype.connect = function (options, callback) {
  ...
  client.on('error', function(err){
    ...
    // TODO: parse errors to determine better action to perform
    return self.list();
